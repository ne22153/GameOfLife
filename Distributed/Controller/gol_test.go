...
func boardFail(t *testing.T, given, expected []util.Cell, p Shared.Params) bool {
...
func assertEqualBoard(t *testing.T, given, expected []util.Cell, p Shared.Params) bool {
	givenLen := len(given)
